def undo_n_code_and_n_bases(n_code, original_n):
    ...
    for i in range(len(n_code)):
        ...
        undo_current_n_code_digit = list(set(sorted_n_list))[current_n_code_digit]
        undo_n_code_list.append(undo_current_n_code_digit)
        sorted_n_list.remove(undo_current_n_code_digit)
...
def n_code_and_n_bases(n):
    ...
    for i in range(len(n_list)):
        ...
        current_digit_code = list(set(sorted_n_list)).index(current_digit)
...
next_bigger(3981) # Not working atm
next_bigger(128350)
next_bigger(100350)
next_bigger(120150)
next_bigger(9876543210)
next_bigger(59884848459853) # Should be 59884848483559.

...
#
# The function perimeter has for parameter n where n + 1 is the number of squares (they
# are numbered from 0 to n) and returns the total perimeter of all the squares.
#
